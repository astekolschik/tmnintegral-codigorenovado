...
<ul class="sidebar-menu">
	...
	<c:if test="${user.role_id == 1 or user.role_id == 2}">
		<li class="treeview">
			...
			<ul class="treeview-menu">
				<li><a href="javascript:displayLisTipoEquipo();"><i class="fa fa-circle-o"></i>Tipos de Equipo</a></li>
				<li><a href="javascript:displayLisEquipo();"><i class="fa fa-circle-o"></i>Equipos</a></li>
				<li><a href="javascript:displayInterfaces();"><i class="fa fa-circle-o"></i>Interfaces</a></li>
				<li><a href="javascript:displayRedes();"><i class="fa fa-circle-o"></i>Redes</a></li>
				<li><a href="javascript:displayTopologiaRed();"><i class="fa fa-circle-o"></i>Topología de Red</a></li>
			</ul>
		</li>
		<li class="treeview">
			<a href="javascript:displayInProgress();">
				<i class="fa fa-files-o"></i><span>Configuracion</span><i class="fa fa-angle-left pull-right"></i>
			</a>
		</li>
	</c:if>
	...
	<li class="treeview">
			<a href="#">
				<i class="fa fa-files-o"></i><span>Monitoreo</span><i class="fa fa-angle-left pull-right"></i>
			</a>
			<ul class="treeview-menu">
				<li><a href="javascript:displayInicioReportes();"><i class="fa fa-circle-o"></i>Reportes</a></li>
				<li><a href="javascript:displayAlarmasEnviadas();"><i class="fa fa-circle-o"></i>Alarmas</a></li>
			</ul>
		</li>
	...
	<li><a href="logout.htm"> <i class="fa fa-th"></i>

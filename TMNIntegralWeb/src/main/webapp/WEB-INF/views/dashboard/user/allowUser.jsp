					...
					<tbody>
						<c:forEach items="${model.userList}" var="user">
							<tr>
								...
								<td>${user.email}</td>
								<td>
									<input type="checkbox" name="enabledCheck" value="${user.user_name}"/>
								</td>
							</tr>
						</c:forEach>
					</tbody>
	  ...
	  <div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-outline" data-dismiss="modal" onclick="habilitarUsuarios();">Habilitar</button>
				</div>
			</div>
		</div>
	</div>
